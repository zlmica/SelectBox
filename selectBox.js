      ...
      if (ev.clientX > posx + selfDiv.offsetLeft - leftScrollDistance) {
        if (ev.clientY > posy + selfDiv.offsetTop - topScrollDistance) {
          ...
          bottomRightPointY =
            Math.abs(
              topScrollDistance -
                Math.abs(ev.clientY - selfDiv.offsetTop - posy)
            ) + posy;
        } else {
          div.removeAttribute("style");
          div.style.left = posx + "px";
